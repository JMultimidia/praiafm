/*!
 * LUNA RADIO PLAYER V5.20.09.08 - CHAN / CHAN STUDIOS
                ...
                ! function () {
                  var t = "GET",
                    ...
                    o = {};
									...
									// Altere a URL para apontar para seu serviço de proxy PHP
        					var proxyUrl = "https://jmhost.com.br/proxyazuracast.php?url=" + encodeURIComponent(i);
                  ...
                  e.ajax({
                    ...
                    method: t,
                    crossDomain: !0,
                    url: proxyUrl, // Use a URL do proxy,
                    data: o,
                    success: function (e) {
                      Ke(e, "")
                    },
          ...
          if (void 0 === l) {
            if ("real" == O) {
              try {
                ...
                }(l), c.smoothingTimeConstant = .9, c.fftSize = 0, xt("analyzer is created")
              } catch (e) {
      ...
      function ut() {
        if ("fake" == O || "real" == O) {
          ...
          "animated" == j && e("#" + n + "smallcoverwrapper, #" + n + "smallcoverwrapper1, #" + n + "smallcoverwrapper2, #" + n + "coverwrapper, #" + n + "coverwrapper1, #" + n + "coverwrapper2").css({
            "border-top-left-radius": 100 - 90 * Ae + "%",
            "border-top-right-radius": 100 - 90 * ye + "%",
            "border-bottom-left-radius": 100 - 90 * Ae + "%",
            "border-bottom-right-radius": 100 - 90 * ye + "%"
          });
          try {
            switch (D) {
              case 0:
